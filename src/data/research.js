export const researchAreas = [
  {
    ...
    image: "/images/research/graph-machine-learning.webp",
    imageAlt:
      "Graph data passing through neural message-passing layers into a learned representation",
    topics: [
...

  {
    ...
    image: "/images/research/spatio-temporal-ai.webp",
    imageAlt:
      "Layered urban maps connected across time with changing spatial activity patterns",
    topics: [
...

  {
    ...
    image: "/images/research/visual-analytics.webp",
    imageAlt:
      "Linked analytical views exploring selected clusters in high-dimensional data",
    topics: [
...

  {
    ...
    imageAlt:
      "Highlighted reasoning paths tracing features through transparent machine-learning layers",
    topics: [
...

  {
    ...
    image: "/images/research/quantification.webp",
    imageAlt:
      "Two data populations flowing into class-prevalence estimates and score distributions",
    topics: [
      "Supervised Learning",
